...
class ProductList extends TPage
{
    ...
    private static $database = 'e-commerce';
    ...
    public function __construct($param = null)
    {
        ...
        $system_users_id = new TDBCombo('system_users_id', 'e-commerce', 'SystemUsers', 'id', '{name}','name asc'  );
        ...
        $row2 = $this->form->addFields([new TLabel("Price:", null, '14px', null, '100%'),$price],[new TLabel("System users id:", null, '14px', null, '100%'),$system_users_id]);
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Básico","Products"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            // open a transaction with database 'e-commerce'
            TTransaction::open(self::$database);
