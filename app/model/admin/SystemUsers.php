...
class SystemUsers extends TRecord
{
    ...
    public function set_product_system_users_to_string($product_system_users_to_string)
    {
        if(is_array($product_system_users_to_string))
        {
            $values = SystemUsers::where('id', 'in', $product_system_users_to_string)->getIndexedArray('name', 'name');
            $this->product_system_users_to_string = implode(', ', $values);
        }
        else
        {
            $this->product_system_users_to_string = $product_system_users_to_string;
        }

        $this->vdata['product_system_users_to_string'] = $this->product_system_users_to_string;
    }

    public function get_product_system_users_to_string()
    {
        if(!empty($this->product_system_users_to_string))
        {
            return $this->product_system_users_to_string;
        }
    
        $values = Product::where('system_users_id', '=', $this->id)->getIndexedArray('system_users_id','{system_users->name}');
